...
Source99 : http://releases.llvm.org/4.0.1/llvm-4.0.1.src.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause MIT NCSA
Requires: compat-llvm-soname4-bin
Requires: compat-llvm-soname4-lib
Requires: compat-llvm-soname4-data
Requires: compat-llvm-soname4-doc
...
%package bin
Summary: bin components for the compat-llvm-soname4 package.
Group: Binaries
Requires: compat-llvm-soname4-data

%description bin
bin components for the compat-llvm-soname4 package.


%package data
Summary: data components for the compat-llvm-soname4 package.
Group: Data

%description data
data components for the compat-llvm-soname4 package.


%package dev
Summary: dev components for the compat-llvm-soname4 package.
Group: Development
Requires: compat-llvm-soname4-lib
Requires: compat-llvm-soname4-bin
Requires: compat-llvm-soname4-data
Provides: compat-llvm-soname4-devel

%description dev
dev components for the compat-llvm-soname4 package.


%package doc
Summary: doc components for the compat-llvm-soname4 package.
Group: Documentation

%description doc
doc components for the compat-llvm-soname4 package.


%package lib
Summary: lib components for the compat-llvm-soname4 package.
Group: Libraries
Requires: compat-llvm-soname4-data

%description lib
lib components for the compat-llvm-soname4 package.


%prep
tar -xf %{SOURCE1}
cd ..
%setup -q -n llvm-4.0.1.src
mkdir -p %{_topdir}/BUILD/llvm-4.0.1.src/tools/clang
mv %{_topdir}/BUILD/cfe-4.0.1.src/* %{_topdir}/BUILD/llvm-4.0.1.src/tools/clang
...
export LANG=C
export SOURCE_DATE_EPOCH=1517627784
mkdir clr-build
pushd clr-build
...
rm -fr %{buildroot}/usr/share/clang/__pycache__
rm -fr %{buildroot}/usr/share/scan-view/__pycache__
...
/usr/lib64/clang/4.0.1/include/cuda_wrappers/algorithm
/usr/lib64/clang/4.0.1/include/cuda_wrappers/complex
/usr/lib64/clang/4.0.1/include/cuda_wrappers/new
/usr/lib64/clang/4.0.1/include/module.modulemap
...
%exclude /usr/include/llvm/CodeGen/MachineFunctionInitializer.h
...
%exclude /usr/include/llvm/DebugInfo/CodeView/CVSymbolTypes.def
%exclude /usr/include/llvm/DebugInfo/CodeView/CVSymbolVisitor.h
%exclude /usr/include/llvm/DebugInfo/CodeView/CVTypeDumper.h
...
%exclude /usr/include/llvm/DebugInfo/CodeView/ModuleSubstream.h
%exclude /usr/include/llvm/DebugInfo/CodeView/ModuleSubstreamVisitor.h
...
%exclude /usr/include/llvm/DebugInfo/CodeView/TypeDatabase.h
%exclude /usr/include/llvm/DebugInfo/CodeView/TypeDatabaseVisitor.h
...
%exclude /usr/include/llvm/DebugInfo/CodeView/TypeDumperBase.h
...
%exclude /usr/include/llvm/DebugInfo/CodeView/TypeRecords.def
...
%exclude /usr/include/llvm/DebugInfo/MSF/ByteStream.h
...
%exclude /usr/include/llvm/DebugInfo/MSF/SequencedItemStream.h
%exclude /usr/include/llvm/DebugInfo/MSF/StreamArray.h
%exclude /usr/include/llvm/DebugInfo/MSF/StreamInterface.h
%exclude /usr/include/llvm/DebugInfo/MSF/StreamReader.h
%exclude /usr/include/llvm/DebugInfo/MSF/StreamRef.h
%exclude /usr/include/llvm/DebugInfo/MSF/StreamWriter.h
...
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/DbiStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/DbiStreamBuilder.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/EnumTables.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/GlobalsStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/Hash.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/ISectionContribVisitor.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/InfoStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/InfoStreamBuilder.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/ModInfo.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/ModStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/NameHashTable.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/NameMap.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/NameMapBuilder.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/PDBFile.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/PDBFileBuilder.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/PublicsStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/RawConstants.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/RawError.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/RawSession.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/RawTypes.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/SymbolStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/TpiHashing.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/TpiStream.h
%exclude /usr/include/llvm/DebugInfo/PDB/Raw/TpiStreamBuilder.h
...
%exclude /usr/include/llvm/ExecutionEngine/Orc/ObjectLinkingLayer.h
...
%exclude /usr/include/llvm/LibDriver/LibDriver.h
...
%exclude /usr/include/llvm/Object/ModuleSummaryIndexObjectFile.h
...
%exclude /usr/include/llvm/Support/COFF.h
...
%exclude /usr/include/llvm/Support/Dwarf.def
%exclude /usr/include/llvm/Support/Dwarf.h
%exclude /usr/include/llvm/Support/DynamicLibrary.h
%exclude /usr/include/llvm/Support/ELF.h
%exclude /usr/include/llvm/Support/ELFRelocs/AArch64.def
%exclude /usr/include/llvm/Support/ELFRelocs/AMDGPU.def
%exclude /usr/include/llvm/Support/ELFRelocs/ARM.def
%exclude /usr/include/llvm/Support/ELFRelocs/AVR.def
%exclude /usr/include/llvm/Support/ELFRelocs/BPF.def
%exclude /usr/include/llvm/Support/ELFRelocs/Hexagon.def
%exclude /usr/include/llvm/Support/ELFRelocs/Lanai.def
%exclude /usr/include/llvm/Support/ELFRelocs/Mips.def
%exclude /usr/include/llvm/Support/ELFRelocs/PowerPC.def
%exclude /usr/include/llvm/Support/ELFRelocs/PowerPC64.def
%exclude /usr/include/llvm/Support/ELFRelocs/RISCV.def
%exclude /usr/include/llvm/Support/ELFRelocs/Sparc.def
%exclude /usr/include/llvm/Support/ELFRelocs/SystemZ.def
%exclude /usr/include/llvm/Support/ELFRelocs/WebAssembly.def
%exclude /usr/include/llvm/Support/ELFRelocs/i386.def
%exclude /usr/include/llvm/Support/ELFRelocs/x86_64.def
...
%exclude /usr/include/llvm/Support/MachO.def
%exclude /usr/include/llvm/Support/MachO.h
...
%exclude /usr/include/llvm/Support/Solaris.h
...
%exclude /usr/include/llvm/Support/Wasm.h
...
%exclude /usr/include/llvm/Target/TargetGlobalISel.td
...
%exclude /usr/include/llvm/Transforms/Utils/MemorySSA.h
...
/usr/lib64/clang/4.0.1/include/__clang_cuda_builtin_vars.h
/usr/lib64/clang/4.0.1/include/__clang_cuda_cmath.h
/usr/lib64/clang/4.0.1/include/__clang_cuda_complex_builtins.h
/usr/lib64/clang/4.0.1/include/__clang_cuda_intrinsics.h
/usr/lib64/clang/4.0.1/include/__clang_cuda_math_forward_declares.h
/usr/lib64/libLLVMAsmPrinter.so.4.0.1
/usr/lib64/libLLVMBPFAsmPrinter.so.4
/usr/lib64/libLLVMBPFAsmPrinter.so.4.0.1
/usr/lib64/libLLVMBPFCodeGen.so.4
/usr/lib64/libLLVMBPFCodeGen.so.4.0.1
/usr/lib64/libLLVMBPFDesc.so.4
/usr/lib64/libLLVMBPFDesc.so.4.0.1
/usr/lib64/libLLVMBPFDisassembler.so.4
/usr/lib64/libLLVMBPFDisassembler.so.4.0.1
/usr/lib64/libLLVMBPFInfo.so.4
/usr/lib64/libLLVMBPFInfo.so.4.0.1
/usr/lib64/libLLVMBitReader.so.4
/usr/lib64/libLLVMBitReader.so.4.0.1
/usr/lib64/libLLVMBitWriter.so.4
/usr/lib64/libLLVMBitWriter.so.4.0.1
/usr/lib64/libLLVMCodeGen.so.4
/usr/lib64/libLLVMCodeGen.so.4.0.1
/usr/lib64/libLLVMCore.so.4
/usr/lib64/libLLVMCore.so.4.0.1
/usr/lib64/libLLVMCoroutines.so.4
/usr/lib64/libLLVMCoroutines.so.4.0.1
/usr/lib64/libLLVMCoverage.so.4
/usr/lib64/libLLVMCoverage.so.4.0.1
/usr/lib64/libLLVMDebugInfoCodeView.so.4
/usr/lib64/libLLVMDebugInfoCodeView.so.4.0.1
/usr/lib64/libLLVMDebugInfoDWARF.so.4
/usr/lib64/libLLVMDebugInfoDWARF.so.4.0.1
/usr/lib64/libLLVMDebugInfoMSF.so.4
/usr/lib64/libLLVMDebugInfoMSF.so.4.0.1
/usr/lib64/libLLVMDebugInfoPDB.so.4
/usr/lib64/libLLVMDebugInfoPDB.so.4.0.1
/usr/lib64/libLLVMDemangle.so.4
/usr/lib64/libLLVMDemangle.so.4.0.1
/usr/lib64/libLLVMExecutionEngine.so.4
/usr/lib64/libLLVMExecutionEngine.so.4.0.1
/usr/lib64/libLLVMGlobalISel.so.4
/usr/lib64/libLLVMGlobalISel.so.4.0.1
/usr/lib64/libLLVMIRReader.so.4
/usr/lib64/libLLVMIRReader.so.4.0.1
/usr/lib64/libLLVMInstCombine.so.4
/usr/lib64/libLLVMInstCombine.so.4.0.1
/usr/lib64/libLLVMInstrumentation.so.4
/usr/lib64/libLLVMInstrumentation.so.4.0.1
/usr/lib64/libLLVMInterpreter.so.4
/usr/lib64/libLLVMInterpreter.so.4.0.1
/usr/lib64/libLLVMLTO.so.4
/usr/lib64/libLLVMLTO.so.4.0.1
/usr/lib64/libLLVMLibDriver.so.4
/usr/lib64/libLLVMLibDriver.so.4.0.1
/usr/lib64/libLLVMLineEditor.so.4
/usr/lib64/libLLVMLineEditor.so.4.0.1
/usr/lib64/libLLVMLinker.so.4
/usr/lib64/libLLVMLinker.so.4.0.1
/usr/lib64/libLLVMMC.so.4
/usr/lib64/libLLVMMC.so.4.0.1
/usr/lib64/libLLVMMCDisassembler.so.4
/usr/lib64/libLLVMMCDisassembler.so.4.0.1
/usr/lib64/libLLVMMCJIT.so.4
/usr/lib64/libLLVMMCJIT.so.4.0.1
/usr/lib64/libLLVMMCParser.so.4
/usr/lib64/libLLVMMCParser.so.4.0.1
/usr/lib64/libLLVMMIRParser.so.4
/usr/lib64/libLLVMMIRParser.so.4.0.1
/usr/lib64/libLLVMNVPTXAsmPrinter.so.4
/usr/lib64/libLLVMNVPTXAsmPrinter.so.4.0.1
/usr/lib64/libLLVMNVPTXCodeGen.so.4
/usr/lib64/libLLVMNVPTXCodeGen.so.4.0.1
/usr/lib64/libLLVMNVPTXDesc.so.4
/usr/lib64/libLLVMNVPTXDesc.so.4.0.1
/usr/lib64/libLLVMNVPTXInfo.so.4
/usr/lib64/libLLVMNVPTXInfo.so.4.0.1
/usr/lib64/libLLVMObjCARCOpts.so.4
/usr/lib64/libLLVMObjCARCOpts.so.4.0.1
/usr/lib64/libLLVMObject.so.4
/usr/lib64/libLLVMObject.so.4.0.1
/usr/lib64/libLLVMObjectYAML.so.4
/usr/lib64/libLLVMObjectYAML.so.4.0.1
/usr/lib64/libLLVMOption.so.4
/usr/lib64/libLLVMOption.so.4.0.1
/usr/lib64/libLLVMOrcJIT.so.4
/usr/lib64/libLLVMOrcJIT.so.4.0.1
/usr/lib64/libLLVMPasses.so.4
/usr/lib64/libLLVMPasses.so.4.0.1
/usr/lib64/libLLVMProfileData.so.4
/usr/lib64/libLLVMProfileData.so.4.0.1
/usr/lib64/libLLVMRuntimeDyld.so.4
/usr/lib64/libLLVMRuntimeDyld.so.4.0.1
/usr/lib64/libLLVMScalarOpts.so.4
/usr/lib64/libLLVMScalarOpts.so.4.0.1
/usr/lib64/libLLVMSelectionDAG.so.4
/usr/lib64/libLLVMSelectionDAG.so.4.0.1
/usr/lib64/libLLVMSupport.so.4
/usr/lib64/libLLVMSupport.so.4.0.1
/usr/lib64/libLLVMSymbolize.so.4
/usr/lib64/libLLVMSymbolize.so.4.0.1
/usr/lib64/libLLVMTableGen.so.4
/usr/lib64/libLLVMTableGen.so.4.0.1
/usr/lib64/libLLVMTarget.so.4
/usr/lib64/libLLVMTarget.so.4.0.1
/usr/lib64/libLLVMTransformUtils.so.4
/usr/lib64/libLLVMTransformUtils.so.4.0.1
/usr/lib64/libLLVMVectorize.so.4
/usr/lib64/libLLVMVectorize.so.4.0.1
/usr/lib64/libLLVMX86AsmParser.so.4
/usr/lib64/libLLVMX86AsmParser.so.4.0.1
/usr/lib64/libLLVMX86AsmPrinter.so.4
/usr/lib64/libLLVMX86AsmPrinter.so.4.0.1
/usr/lib64/libLLVMX86CodeGen.so.4
/usr/lib64/libLLVMX86CodeGen.so.4.0.1
/usr/lib64/libLLVMX86Desc.so.4
/usr/lib64/libLLVMX86Desc.so.4.0.1
/usr/lib64/libLLVMX86Disassembler.so.4
/usr/lib64/libLLVMX86Disassembler.so.4.0.1
/usr/lib64/libLLVMX86Info.so.4
/usr/lib64/libLLVMX86Info.so.4.0.1
/usr/lib64/libLLVMX86Utils.so.4
/usr/lib64/libLLVMX86Utils.so.4.0.1
/usr/lib64/libLLVMXRay.so.4
/usr/lib64/libLLVMXRay.so.4.0.1
/usr/lib64/libLLVMipo.so.4
/usr/lib64/libLLVMipo.so.4.0.1
/usr/lib64/libLTO.so.4
/usr/lib64/libLTO.so.4.0.1
/usr/lib64/libclang.so.4
/usr/lib64/libclang.so.4.0
/usr/lib64/libclangARCMigrate.so.4
/usr/lib64/libclangARCMigrate.so.4.0.1
/usr/lib64/libclangAST.so.4
/usr/lib64/libclangAST.so.4.0.1
/usr/lib64/libclangASTMatchers.so.4
/usr/lib64/libclangASTMatchers.so.4.0.1
/usr/lib64/libclangAnalysis.so.4
/usr/lib64/libclangAnalysis.so.4.0.1
/usr/lib64/libclangBasic.so.4
/usr/lib64/libclangBasic.so.4.0.1
/usr/lib64/libclangCodeGen.so.4
/usr/lib64/libclangCodeGen.so.4.0.1
/usr/lib64/libclangDriver.so.4
/usr/lib64/libclangDriver.so.4.0.1
/usr/lib64/libclangDynamicASTMatchers.so.4
/usr/lib64/libclangDynamicASTMatchers.so.4.0.1
/usr/lib64/libclangEdit.so.4
/usr/lib64/libclangEdit.so.4.0.1
/usr/lib64/libclangFormat.so.4
/usr/lib64/libclangFormat.so.4.0.1
/usr/lib64/libclangFrontend.so.4
/usr/lib64/libclangFrontend.so.4.0.1
/usr/lib64/libclangFrontendTool.so.4
/usr/lib64/libclangFrontendTool.so.4.0.1
/usr/lib64/libclangIndex.so.4
/usr/lib64/libclangIndex.so.4.0.1
/usr/lib64/libclangLex.so.4
/usr/lib64/libclangLex.so.4.0.1
/usr/lib64/libclangParse.so.4
/usr/lib64/libclangParse.so.4.0.1
/usr/lib64/libclangRewrite.so.4
/usr/lib64/libclangRewrite.so.4.0.1
/usr/lib64/libclangRewriteFrontend.so.4
/usr/lib64/libclangRewriteFrontend.so.4.0.1
/usr/lib64/libclangSema.so.4
/usr/lib64/libclangSema.so.4.0.1
/usr/lib64/libclangSerialization.so.4
/usr/lib64/libclangSerialization.so.4.0.1
/usr/lib64/libclangStaticAnalyzerCheckers.so.4
/usr/lib64/libclangStaticAnalyzerCheckers.so.4.0.1
/usr/lib64/libclangStaticAnalyzerCore.so.4
/usr/lib64/libclangStaticAnalyzerCore.so.4.0.1
/usr/lib64/libclangStaticAnalyzerFrontend.so.4
/usr/lib64/libclangStaticAnalyzerFrontend.so.4.0.1
/usr/lib64/libclangTooling.so.4
/usr/lib64/libclangTooling.so.4.0.1
/usr/lib64/libclangToolingCore.so.4
/usr/lib64/libclangToolingCore.so.4.0.1
